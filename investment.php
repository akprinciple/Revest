...
<body>
                                            ...
                                            <div class="table-wrapper">
                                                <table>
                                                    <tr>
                                                     ...
                                                     <?php
                                                    $select = mysqli_query($connect, "SELECT * FROM investments WHERE status = 1 && user_id = '{$ses_row['id']}'");
                                                    $n = 1;
                    ...
                    ?>
                                                    <tr>
                                                        <td>
                                                          <a href="property-details?id=<?php echo md5($pro['id']); ?>" style="color: #13216e;">
                                            ...
                                            <div class="statistics">
                                                ...
                                                <div class="group">
                                                    ...
                                                    <div>
                                                        <h4>$
                                                            <?php 
                                                            $sel = mysqli_query($connect, "SELECT SUM(amount_invested) AS total FROM investments WHERE user_id = '{$ses_row['id']}' && status = 1"); 
      ...
      series: [
        {
          name: "Invested",
          data: [<?php 
            $sel = mysqli_query($connect, "SELECT SUM(amount_invested) AS total FROM investments WHERE user_id = '{$ses_row['id']}' && status =1 GROUP BY month ORDER BY month ASC");
                foreach ($sel as $key ) {
                    echo $key['total'].",";
                }
             ?>],
